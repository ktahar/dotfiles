...
nnoremap <expr><silent><buffer> <LocalLeader>e <SID>Latexmk('default', 1, 0)
nnoremap <expr><silent><buffer> <LocalLeader>E <SID>Latexmk('default', 0, 1)
nnoremap <expr><silent><buffer> <LocalLeader>x <SID>Latexmk('pdf', 1, 0)
nnoremap <expr><silent><buffer> <LocalLeader>X <SID>Latexmk('pdf', 0, 1)
"nnoremap <expr><silent><buffer> <LocalLeader>e <SID>TypesetFile()
nnoremap <expr><silent><buffer> <LocalLeader>v <SID>ViewFile(1)
nnoremap <expr><silent><buffer> <LocalLeader>f <SID>ViewFile(0)
nnoremap <expr><silent><buffer> <LocalLeader>r <SID>SetTeXmasterCurrent()
nnoremap <expr><silent><buffer> <LocalLeader>R <SID>EchoTeXmaster()
