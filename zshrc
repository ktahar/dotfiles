...
alias gil='git log'
alias gig='git graph'
alias t='tmux start && tmux a -t main'
alias q='exit'
alias tk='bash ~/.tmux/plugins/tmux-resurrect/scripts/save.sh && tmux kill-server'
alias qa='bash ~/.tmux/plugins/tmux-resurrect/scripts/save.sh && tmux kill-server'
alias ipy='ipython3'
alias ipy3='ipython3'
alias ipy2='ipython2'
