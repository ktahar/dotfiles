...
## Type: Dict
# c.aliases = {'q': 'close', 'wqa': 'quit --save', 'qa': 'quit', 'w': 'session-save', 'wq': 'quit --save'}
...
c.bindings.key_mappings = {'<Shift-Enter>': '<Return>', '<Ctrl-[>': '<Escape>', '<Shift-Return>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-6>': '<Ctrl-^>', '<Ctrl-J>': '<Escape>'}
##! Ctrl-J is Escape for me.
...
## Type: Dict
# c.content.javascript.log = {'info': 'debug', 'warning': 'debug', 'unknown': 'debug', 'error': 'debug'}
...
## hints.
## Type: Dict
# c.hints.selectors = {'links': ['a[href]', 'area[href]', 'link[href]', '[role="link"][href]'], 'all': ['a', 'area', 'textarea', 'select', 'input:not([type="hidden"])', 'button', 'frame', 'iframe', 'img', 'link', 'summary', '[onclick]', '[onmousedown]', '[role="link"]', '[role="option"]', '[role="button"]', '[ng-click]', '[ngClick]', '[data-ng-click]', '[x-ng-click]', '[tabindex]'], 'images': ['img'], 'media': ['audio', 'img', 'video'], 'url': ['[src]', '[href]'], 'inputs': ['input[type="text"]', 'input[type="date"]', 'input[type="datetime-local"]', 'input[type="email"]', 'input[type="month"]', 'input[type="number"]', 'input[type="password"]', 'input[type="search"]', 'input[type="tel"]', 'input[type="time"]', 'input[type="url"]', 'input[type="week"]', 'input:not([type])', 'textarea']}
...
## Type: Padding
# c.tabs.indicator.padding = {'bottom': 2, 'top': 2, 'left': 0, 'right': 4}
...
## for a blank page.
## Type: FuzzyUrl
c.url.default_page = 'https://www.google.co.jp/'
...
c.url.start_pages = ['https://www.google.co.jp/']
